...
namespace WorldOfSpirits.EditorTools
{
    ...
    {
        private const string ProjectRoot = "Assets/_WorldOfSpirits";
        private const string FirePrefabPath = ProjectRoot + "/Prefabs/Spirits/Fire Spirit.prefab";
        private const string EarthPrefabPath = ProjectRoot + "/Prefabs/Spirits/Earth Spirit.prefab";
        private const string IcePrefabPath = ProjectRoot + "/Prefabs/Spirits/Ice Spirit.prefab";
        ...
        private static void ConnectFire()
        {
            ...
            AssignDefinition(member, ProjectRoot + "/Data/Spirits/Fire Spirit.asset");
            ...
            GameObject bowProjectile = AssetDatabase.LoadAssetAtPath<GameObject>(
                ProjectRoot + "/Prefabs/Projectiles/Fire/FireFeather.prefab");
            ...
            GameObject projectileObject = AssetDatabase.LoadAssetAtPath<GameObject>(
                ProjectRoot + "/Prefabs/Projectiles/Fire/FireFeather.prefab");
        ...
        private static void ConnectEarth()
        {
            ...
            GameObject hammerPrefab = AssetDatabase.LoadAssetAtPath<GameObject>(
                ProjectRoot + "/Prefabs/Weapons/Earth/Stone Hammer.prefab");
        ...
        private static void ConnectIce()
        {
            ...
            SpiritMember member = GetOrAdd<SpiritMember>(root);
            AssignDefinition(member, ProjectRoot + "/Data/Spirits/Ice Spirit.asset");
