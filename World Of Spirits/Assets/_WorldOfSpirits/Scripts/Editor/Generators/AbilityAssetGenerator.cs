...
namespace WorldOfSpirits.EditorTools
{
    public static class AbilityAssetGenerator
    {
        ...
        private const string AbilityRoot = ProjectRoot + "/Data/Abilities";
        private const string SpiritFolder = ProjectRoot + "/Data/Spirits";
        ...
        {
            string elementFolder = $"{AbilityRoot}/{spec.Spirit}";
        ...
        private static AbilityLevelData BuildLevel(Spec spec, int index)
        {
            ...
            {
                GameObject fireFeather = AssetDatabase.LoadAssetAtPath<GameObject>(
            ...
            if (spec.Name == "Tidal Wave")
            {
                GameObject tsunami = AssetDatabase.LoadAssetAtPath<GameObject>(
                    ProjectRoot + "/Prefabs/Projectiles/Water/Tsunami.prefab");
            ...
            {
                GameObject boulder = AssetDatabase.LoadAssetAtPath<GameObject>(
                    ProjectRoot + "/Prefabs/Projectiles/Earth/Boulder.prefab");
            ...
            if (spec.Name == "Orbital Snowball")
            {
                ...
                level.spawnedEffectPrefab = AssetDatabase.LoadAssetAtPath<GameObject>(
                    ProjectRoot + "/Prefabs/Abilities/Ice/Orbital Snowball.prefab");
            }
            if (spec.Name == "Ice Crystal")
            {
                level.spawnedEffectPrefab = AssetDatabase.LoadAssetAtPath<GameObject>(
                    ProjectRoot + "/Prefabs/Abilities/Ice/Ice Crystal.prefab");
