...
- `Assets/Scripts/Progression/Pickups` - collectible experience behavior and pooling services.
- `Assets/Scripts/Progression/Unlocks` - spirit unlock state and progression.
- `Assets/Scripts/UI/Progression` - player progression HUD and UI contracts.
- `Assets/Scripts/UI/SpiritSelection` - starter-spirit selection screens and card views.
...
- `Assets/Prefabs/Pickups/Experience` - experience pickup prefabs.
- `Assets/Prefabs/UI/SpiritSelection` - starter-spirit selection prefabs.
- `Assets/Art/Sprites/Spirits` - source sprites grouped by spirit.
- `Assets/Art/UI/Progression` - progression bars and other progression UI art.
...
- `Assets/Settings/Rendering` - render-pipeline and volume assets.
- `Assets/Settings/Input` - Input System action assets.
- `Assets/Documentation` - project setup guides and structure documentation.
